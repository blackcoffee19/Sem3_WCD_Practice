...
<div class="container-fluid">
	<div class="row">
		<div class="col-lg-6 col-md-8 mx-auto">
			<h2 class="my-5">Create new Glass</h2>
				...
				<div class="card">
					<div class="card-body">
						<div class="mb-3">
							...
							<input type="text" name="name" id="name" class="form-control" placeholder="Enter Glass Name" />
						</div>
						<div class="mb-3">
							<label class="form-label" for="price">Price</label>
							<input type="text" name="price" id="price" class="form-control" placeholder="Enter Glass Price" />
						</div>
						<div class="mb-3">
