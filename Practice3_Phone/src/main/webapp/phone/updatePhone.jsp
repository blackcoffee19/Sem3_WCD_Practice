		...
		<div class="col-lg-6 col-md-8 mx-auto">
			...
			<form action="${pageContext.request.contextPath}/ProcessServlet?a=Update" method="post" enctype="multipart/form-data">
				<div class="card">
					<div class="card-body">
						<div class="mb-3">
						<input name="id" type="hidden" value="<%=phone.getPId() %>" />
							<label class="form-label" for="name">Phone Name</label>
							<input type="text" name="name" id="name" class="form-control" value="<%=phone.getName() %>"/>
						</div>
						<div class="mb-3">
							<label class="form-label" for="price">Price</label>
							<input type="text" name="price" id="price" class="form-control" value="<%=phone.getPrice() %>" />
						</div>
						<div class="mb-3">
							<label class="col-form-label col-6" for="photo">Image</label>
							<div class="col-6">
							<img alt="<%=phone.getName() %>" src="images/<%=phone.getImage() %>" class="img-fluid" width="130">
							</div>
